            ...
            <main className="max-w-[1500px] mx-auto px-4 md:px-10 py-6 md:py-10 flex flex-col lg:flex-row">
                    ...
                    <div className="space-y-6 text-secondary-foreground">
                        ...
                        <div>
                            ...
                            <div className="space-y-3.5 text-[11px] tracking-wide">
                                <label className="flex items-center space-x-3 cursor-pointer group">
                                    <div className="w-[14px] h-[14px] rounded-full border border-secondary-foreground flex items-center justify-center transition-colors">
                                        <div className="w-[6px] h-[6px] rounded-full bg-secondary-foreground"></div>
                                    </div>
                                    <span className="group-hover:text-black transition-colors">All Products</span>
                                </label>
                                <label className="flex items-center space-x-3 cursor-pointer group">
                                    <div className="w-[14px] h-[14px] rounded-full border border-input group-hover:border-secondary-foreground transition-colors"></div>
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2 text-[10px] font-semibold text-gray-500">
                                <div className="w-9 h-7 border border-input rounded flex items-center justify-center cursor-pointer hover:border-secondary-foreground hover:text-secondary-foreground transition-colors bg-card/50">XS</div>
                                <div className="w-9 h-7 border border-input rounded flex items-center justify-center cursor-pointer hover:border-secondary-foreground hover:text-secondary-foreground transition-colors bg-card/50">S</div>
                                <div className="w-9 h-7 border border-input rounded flex items-center justify-center cursor-pointer hover:border-secondary-foreground hover:text-secondary-foreground transition-colors bg-card/50">M</div>
                                <div className="w-9 h-7 border border-input rounded flex items-center justify-center cursor-pointer hover:border-secondary-foreground hover:text-secondary-foreground transition-colors bg-card/50">L</div>
                                <div className="w-9 h-7 border border-input rounded flex items-center justify-center cursor-pointer hover:border-secondary-foreground hover:text-secondary-foreground transition-colors bg-card/50">XL</div>
                            </div>
                        </div>
                    </div>
                </aside>
                ...
                <div className="flex-1">
                    ...
                    <div className="flex justify-between items-end mb-6 pb-2 border-b border-transparent">
                        ...
                        <div className="flex items-center text-[11px] text-secondary-foreground cursor-pointer group tracking-wide">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-3 md:gap-x-5 gap-y-6 md:gap-y-10">
                        {products.map((product) => (
                            <Link href="/detail" key={product.id} className="flex flex-col h-full group cursor-pointer">
                                ...
                                {/* Price */}
                                <div className="text-[11px] text-secondary-foreground mb-4">
                                    {product.price}
                                </div>
