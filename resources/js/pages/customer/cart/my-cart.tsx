...
const suggestedProducts = [
    { id: 1, title: "Zahra Khimar", price: "Rp 249.000", image: "/img/hasan-almasi-_X2UAmIcpko-unsplash.webp" },
    { id: 2, title: "Luthfah Abaya", price: "Rp 729.000", image: "/img/ike-ellyana-2F70bGqQVa4-unsplash.webp" },
    { id: 3, title: "Amani Scarf", price: "Rp 189.000", image: "/img/khaled-ghareeb-n84s3jgzhKk-unsplash.webp" },
    { id: 4, title: "Madinah Abaya", price: "Rp 749.000", image: "/img/m-ghufanil-muta-ali-vAyDuvcjXcs-unsplash.webp" },
];
                ...
                {!isEmpty ? (
                    <>
                            ...
                            <div className="w-full lg:w-[380px] flex-shrink-0">
                                <div className="bg-white rounded-2xl border border-[#EAE8E3]/80 p-6 md:p-8 shadow-xl shadow-black/5 sticky top-24 lg:top-32">
                                    ...
                                    <div className="space-y-4">
                                        <Link href="/checkout" className="block w-full py-4 rounded-lg bg-[#3C3428] text-center text-white text-[13px] font-bold tracking-wider hover:bg-[#2D261C] hover:shadow-lg hover:shadow-[#3C3428]/20 transition-all active:scale-[0.98]">
                                            Proceed to Checkout
                                        </Link>
                                        <div className="text-center">
                                            <Link href="/list" className="inline-block text-[12px] text-[#8C8578] font-medium underline underline-offset-4 hover:text-black transition-colors">
                                                Continue Shopping
                                            </Link>
                                        </div>
                                    </div>
                        ...
                        <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-[#3C3428] text-white p-4 pb-safe flex justify-between items-center shadow-[0_-10px_40px_rgba(0,0,0,0.15)] z-40 transform translate-y-0 transition-transform">
                            ...
                            <Link href="/checkout" className="px-6 py-3 bg-[#EAE4D9] text-[#3C3428] rounded-md text-xs font-bold tracking-wide hover:bg-white transition-colors active:scale-95">
                    ...
                    <div className="flex flex-col items-center justify-center py-20 md:py-32 animate-fade-in-up">
                        ...
                        <Link href="/list" className="px-8 py-4 bg-[#3C3428] text-white text-sm font-bold tracking-wider rounded-lg hover:bg-[#2D261C] hover:shadow-xl transition-all hover:-translate-y-1 active:translate-y-0">
                            Explore Collection
                        </Link>
                    </div>
                )}
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
                            {suggestedProducts.map((product, idx) => (
                                ...
                                >
                                    ...
                                    <span className="w-full py-2.5 md:py-3 border border-[#EAE8E3] bg-[#FAF9F6] text-[#4A4A4A] text-[10px] md:text-[11px] font-bold tracking-wider rounded-md hover:bg-[#3C3428] hover:text-white hover:border-[#3C3428] transition-all flex items-center justify-center group-hover:shadow-md">
