...
import { 
    Search, ChevronDown, LayoutDashboard, User, ShoppingBag, Heart, 
    MapPin, CreditCard, LogOut, Package, Check, Truck, ChevronLeft, ChevronRight 
} from 'lucide-react';
...
const ORDERS = [
    {
        ...
        total: 1128000,
        items: [
            { id: 1, title: 'Najran Piping Lace Abaya', color: 'Off White', size: 'M', qty: 1, image: '/img/abdul-raheem-kannath-aNWfK46QWto-unsplash.jpg' },
            { id: 2, title: 'Sila Scarf', color: 'Sand Beige', size: 'Standard', qty: 1, image: '/img/ainur-iman-qcNmigFPTQM-unsplash.jpg' },
        ],
        extraItems: 1
    },
    {
        ...
        total: 799000,
        items: [
            { id: 1, title: 'Kufah Khimar', color: 'Taupe', size: 'M', qty: 1, image: '/img/atiyeh-fathi-CvdzGjVX9DA-unsplash.jpg' },
            { id: 2, title: 'Sila Scarf', color: 'Sand Beige', size: 'Standard', qty: 1, image: '/img/hasan-almasi-_X2UAmIcpko-unsplash.jpg' },
        ],
        extraItems: 0
    },
    {
        ...
        total: 1287000,
        items: [
            { id: 1, title: 'Najran Piping Lace Abaya', color: 'Off White', size: 'M', qty: 1, image: '/img/ike-ellyana-2F70bGqQVa4-unsplash.jpg' },
            { id: 2, title: 'Kufah Khimar', color: 'Taupe', size: 'M', qty: 1, image: '/img/khaled-ghareeb-n84s3jgzhKk-unsplash.jpg' },
        ],
        extraItems: 2,
    ...
    },
    {
        ...
        total: 598000,
        items: [
            { id: 1, title: 'Zahra Dress', color: 'Mauve', size: 'M', qty: 1, image: '/img/m-ghufanil-muta-ali-vAyDuvcjXcs-unsplash.jpg' },
        ],
        extraItems: 0
    },
    {
        ...
        total: 299000,
        items: [
            { id: 1, title: 'Sila Scarf', color: 'Muted Blush', size: 'Standard', qty: 1, image: '/img/abdul-raheem-kannath-aNWfK46QWto-unsplash.jpg' },
        ],
        extraItems: 0
    }
];
                        ...
                        {isEmpty || filteredOrders.length === 0 ? (
                            <div className="bg-white border border-[#EAE8E3] rounded-2xl flex flex-col items-center justify-center py-20 px-6 text-center animate-fade-in-up">
                                <div className="w-48 h-48 mb-6 relative">
                                    ...
                                    <img src="/img/hasan-almasi-_X2UAmIcpko-unsplash.jpg" alt="Empty Box" className="w-full h-full object-cover rounded-xl shadow-lg relative z-10" />
                                </div>
                                ...
                                <div className="flex flex-col sm:flex-row gap-3">
                                    ...
                                    <button className="px-8 py-3 bg-white border border-[#EAE8E3] text-[#3C3428] text-[12px] font-bold tracking-wider rounded-lg hover:border-[#C4BDB1] hover:bg-[#FAF9F6] transition-all">
                                        Browse New Arrivals
                                    </button>
                                </div>
                            </div>
                                        ...
                                        <div className="p-5 md:p-6 flex flex-col lg:flex-row gap-6 justify-between items-start lg:items-center">
                                            ...
                                            <div className="w-full lg:w-[200px] flex flex-row lg:flex-col gap-3 flex-shrink-0 mt-4 lg:mt-0">
                                                {order.orderStatus === 'Pending Payment' && (
                                                    <button className="flex-1 lg:w-full py-2.5 bg-[#3C3428] text-white text-[12px] font-bold rounded-lg hover:bg-[#2D261C] transition-colors shadow-md shadow-[#3C3428]/20">
                                                        Pay Now
                                                    </button>
                                                )}
                                                ...
                                                <button className="flex-1 lg:w-full py-2.5 bg-white border border-[#EAE8E3] text-[#3C3428] text-[12px] font-bold rounded-lg hover:bg-[#FAF9F6] hover:border-[#C4BDB1] transition-colors">
