    ...
    return (
        <AppLayout>
            ...
            <section className="relative w-full h-[60vh] md:h-[85vh] overflow-hidden group">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-[#FAF9F6] px-4">
                    ...
                    <div className="mt-2 md:mt-4 animate-fade-in-up">
                        <h2 className="text-3xl sm:text-4xl md:text-6xl font-serif italic mb-1 md:mb-2 tracking-wide text-[#EAE8E3]">Moov</h2>
            ...
            <section className="py-12 md:py-20 px-4 md:px-10 max-w-[1500px] mx-auto">
                <div className="text-center mb-8 md:mb-12">
                    <h2 className="text-xl md:text-3xl font-serif italic text-[#555024] mb-2">Itsar Hajj Series 2026</h2>
                    <p className="text-[10px] md:text-xs tracking-[0.1em] text-[#8C8578] uppercase">Now Served Warmly, Wrapped With Love</p>
                </div>
                            ...
                            {hajjSeries.map(item => (
                                <div key={item.id} className="min-w-[45%] sm:min-w-[30%] md:min-w-0 snap-start flex flex-col group cursor-pointer">
                                    <div className="relative aspect-[3/4] overflow-hidden rounded-sm mb-3">
                                        {item.label && (
                                            <span className="absolute top-2 left-2 z-10 bg-[#FAF9F6]/90 px-2 py-1 text-[8px] font-bold tracking-widest uppercase">
                                                {item.label}
                                            </span>
                                        )}
                                        <img 
                                    ...
                                    <div className="text-center px-1">
                                        ...
                                        <p className="text-[10px] md:text-xs text-[#8C8578] mb-3">{item.price}</p>
                                        <button className="text-[9px] md:text-[10px] uppercase font-bold tracking-wider border-b border-black pb-0.5 hover:text-[#555024] hover:border-[#555024] transition-colors">
                                            Buy
                                        </button>
                                    </div>
                                </div>
            ...
            <section className="py-12 md:py-16 px-4 md:px-10 max-w-[1500px] mx-auto">
                <div className="text-center mb-8 md:mb-12">
                    <h2 className="text-xl md:text-3xl font-serif italic text-[#555024] mb-2">We Present to You...</h2>
                    <p className="text-[10px] md:text-xs tracking-[0.1em] text-[#8C8578] uppercase">More Love. A Special Addition, Exclusively For You</p>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-5">
                    {wePresent.map(item => (
                        <div key={item.id} className="flex flex-col group cursor-pointer">
                            <div className="relative aspect-[3/4] overflow-hidden rounded-sm mb-3">
                                {item.label && (
                                    <span className="absolute top-2 left-2 z-10 bg-[#E62B28] text-white px-2 py-0.5 text-[8px] font-bold tracking-widest">
                                        {item.label}
                                    </span>
                                )}
                                <img 
                            ...
                            <div className="px-1">
                                ...
                                <p className="text-[10px] md:text-xs text-[#8C8578] mb-2 md:mb-3">{item.price}</p>
                                <button className="w-full py-2 bg-[#555024] text-white text-[9px] md:text-[10px] font-bold tracking-widest uppercase hover:bg-[#403B1A] transition-colors rounded-sm">
                                    Buy
                                </button>
                            </div>
                        </div>
            ...
            <section className="py-12 md:py-16 px-4 md:px-10 bg-white">
                <div className="max-w-[1500px] mx-auto">
                    <div className="text-center mb-8 md:mb-12">
                        <h2 className="text-xl md:text-3xl font-serif italic text-[#555024] mb-2">Recent Addition</h2>
                        <p className="text-[10px] md:text-xs tracking-[0.1em] text-[#8C8578] uppercase">Your Beloved Essentials, Now in Colors</p>
                    </div>
                        ...
                        <div className="flex overflow-x-auto snap-x snap-mandatory hide-scrollbar gap-3 md:gap-4 pb-4 md:grid md:grid-cols-3 lg:grid-cols-6 md:pb-0">
                            {recentAdditions.map(item => (
                                <div key={item.id} className="min-w-[40%] sm:min-w-[30%] md:min-w-0 snap-start flex flex-col group cursor-pointer text-center">
                                    <div className="relative aspect-[3/4] overflow-hidden rounded-sm mb-3 bg-[#FAF9F6]">
                                        <img 
                                            src={item.image} 
                                            alt={item.name}
                                            className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                                    ...
                                    <p className="text-[9px] md:text-[10px] text-[#8C8578] mb-2">{item.price}</p>
            ...
            <section className="py-12 md:py-20 px-4 md:px-10 max-w-[1500px] mx-auto">
                <div className="text-center mb-8 md:mb-12">
                    <h2 className="text-xl md:text-3xl font-serif italic text-[#555024] mb-2">Most Loved Essentials</h2>
                    <p className="text-[10px] md:text-xs tracking-[0.1em] text-[#8C8578] uppercase">Classics And Verified By Many, To Be Your Next Favorites</p>
                </div>
                        ...
                        {mostLoved.map(item => (
                            <div key={item.id} className="min-w-[65%] sm:min-w-[45%] md:min-w-0 snap-start flex flex-col group cursor-pointer">
                                <div className="relative aspect-[3/4] overflow-hidden rounded-sm mb-3 md:mb-4">
                                    {item.label && (
                                        <span className="absolute top-2 left-2 z-10 bg-[#FAF9F6] text-[#4A4A4A] px-2 py-1 text-[8px] font-bold tracking-widest uppercase">
                                            {item.label}
                                        </span>
                                    )}
                                    <img 
                                ...
                                <div className="px-1">
                                    <h3 className="text-[10px] md:text-xs font-semibold mb-1 truncate">{item.name}</h3>
                                    <p className="text-[10px] md:text-xs text-[#8C8578] mb-2 md:mb-3">{item.price}</p>
                                    <button className="w-full py-2.5 bg-[#555024] text-white text-[9px] md:text-[10px] font-bold tracking-widest uppercase hover:bg-[#403B1A] transition-colors rounded-sm">
                                        Buy
                                    </button>
                                </div>
                            </div>
            ...
            <section className="py-10 px-4 md:px-10 max-w-[1500px] mx-auto mb-10 md:mb-20">
                <div className="mb-6 md:mb-8">
                    <h2 className="text-lg md:text-xl font-bold text-[#555024] tracking-wider">Our Journal</h2>
                </div>
                    ...
                    {journalPosts.map(post => (
                        <div key={post.id} className="min-w-[75%] sm:min-w-[45%] md:min-w-0 snap-start flex flex-col group cursor-pointer">
                            ...
                            <div className="flex-1 flex flex-col justify-between px-1">
                                <div>
                                    <p className="text-[9px] md:text-[10px] text-[#8C8578] mb-1.5 md:mb-2 uppercase tracking-wider">{post.date}</p>
                                    <h3 className="text-[11px] md:text-xs font-semibold mb-3 md:mb-4 leading-relaxed group-hover:text-[#555024] transition-colors line-clamp-3">
                                        {post.title}
                                    </h3>
                                </div>
                                <div className="mt-auto">
                                    <button className="text-[9px] md:text-[10px] uppercase font-bold tracking-wider border border-[#EAE8E3] px-3 py-1 md:px-4 md:py-1.5 rounded-full hover:border-black transition-colors">
                                        Continue Reading
                                    </button>
                                </div>
                            </div>
