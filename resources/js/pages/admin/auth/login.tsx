            ...
            <main className="grid min-h-screen bg-[#f7f1ea] lg:grid-cols-[minmax(0,0.9fr)_minmax(480px,1fr)]">
                <section className="relative hidden overflow-hidden bg-[#2f241b] p-12 text-white lg:block">
                    ...
                    <div className="relative z-10 flex h-full flex-col justify-between">
                        ...
                        <div>
                            <p className="mb-4 text-sm font-bold uppercase tracking-[0.2em] text-[#d7bfa8]">Admin Operations</p>
                            <h1 className="max-w-xl font-serif text-6xl leading-[0.98]">Manage every order with calm control.</h1>
                            <p className="mt-6 max-w-lg text-base leading-7 text-[#e9dacc]">
                                Product, stock, order, payment, shipment, and content management in one focused workspace.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="flex items-center justify-center px-6 py-12">
                    <div className="w-full max-w-md rounded-2xl border border-[#eadfd4] bg-white p-8 shadow-[0_24px_70px_rgba(63,45,31,0.1)]">
                        <div className="mb-8 flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="font-serif text-3xl text-[#2f241b]">Admin Login</h1>
                                <p className="text-sm text-[#76685e]">Only active admin accounts can continue.</p>
                            </div>
                        </div>

                        <form onSubmit={submit} className="space-y-5">
                            <div>
                                <label htmlFor="email" className="text-sm font-semibold text-[#3e3026]">
                                    Email
                                </label>
                                <input
                                    id="email"
                                    ...
                                    className="mt-2 h-11 w-full rounded-lg border border-[#dfd2c7] bg-[#fffdf9] px-4 text-sm outline-none transition focus:border-[#8f684b] focus:ring-2 focus:ring-[#ead8c8]"
                                    autoComplete="email"
                                    autoFocus
                                />
                            ...
                            <div>
                                <label htmlFor="password" className="text-sm font-semibold text-[#3e3026]">
                                    Password
                                </label>
                                <input
                                    id="password"
