                ...
                <section className="relative hidden overflow-hidden bg-[#4A1111] p-12 text-white lg:block">
                    ...
                    <div className="relative z-10 flex h-full flex-col justify-between">
                        ...
                        <div>
                            ...
                            <p className="mt-6 max-w-lg text-base leading-7 text-[#F1D8D3]">
                ...
                <section className="flex items-center justify-center px-6 py-12">
                    <div className="w-full max-w-md rounded-2xl border border-[#eadfd4] bg-white p-8 shadow-[0_24px_70px_rgba(63,45,31,0.1)]">
                        <div className="mb-8 flex items-center gap-3">
                            <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#4A1111] text-white">
                                <LockKeyhole size={21} strokeWidth={1.7} />
                            </span>
                            <div>
                                <h1 className="font-serif text-3xl text-[#4A1111]">
                                    Admin Login
                                </h1>
                        ...
                        <form onSubmit={submit} className="space-y-5">
                            ...
                            <label className="flex items-center gap-3 text-sm font-medium text-[#5f5045]">
                                <input
                                    ...
                                    className="h-4 w-4 rounded border-[#d8c9ba] text-[#4A1111]"
                                />
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-[#4A1111] text-sm font-bold text-white transition hover:bg-[#4a382b] disabled:opacity-70"
                            >
                                {processing && (
                                    <LoaderCircle
