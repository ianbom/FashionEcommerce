        ...
        <>
            ...
            <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
                <PageHeader
                    ...
                    title="Shipments"
                    description="Pantau pengiriman Biteship, waybill, biaya, estimasi, dan tracking status."
                />
                <TableShell
                    title="Shipment List"
                    description={`${shipments.total} shipment tercatat`}
                >
                    <form
                        onSubmit={submit}
                    ...
                    >
                        <Input
                            ...
                            placeholder="Order/waybill..."
                        />
                        <Input
                            value={data.courier_company}
                            onChange={(event) =>
                                setData('courier_company', event.target.value)
                            }
                            placeholder="Courier"
                        />
                        <Input
                            ...
                            onChange={(event) =>
                                setData('courier_type', event.target.value)
                            }
                            placeholder="Type"
                        />
                        <select
                            ...
                            onChange={(event) =>
                                setData('shipping_status', event.target.value)
                            }
