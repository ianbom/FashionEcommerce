...
export { ActiveBadge, EmptyState, formatPrice, PageHeader, Pagination, TableShell, Thumbnail };
export type { Paginated };

export function ReadBadge({ read }: { read: boolean }) {
    return (
        <Badge variant="outline" className={read ? 'border-zinc-200 bg-zinc-50 text-zinc-600' : 'border-blue-200 bg-blue-50 text-blue-700'}>
            {read ? 'Read' : 'Unread'}
        </Badge>
    );
}
