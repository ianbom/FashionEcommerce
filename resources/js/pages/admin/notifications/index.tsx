        ...
        <>
            ...
            <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
                <PageHeader
                    ...
                    title="Notifications"
                    description="Pantau dan kirim notifikasi manual untuk customer atau segment customer aktif."
                    action={
                        <Button asChild>
                ...
                <TableShell
                    ...
                    description={`${notifications.total} notification tersimpan`}
                >
                    <form
                        onSubmit={submit}
                    ...
                    >
                        <Input
                            ...
                            placeholder="Title, message, customer..."
                        />
                        <select
                            value={data.type}
                            onChange={(event) =>
                        ...
                        <select
                            value={data.read}
                            onChange={(event) =>
                                setData('read', event.target.value)
                            }
                            className="rounded-md border border-input bg-transparent px-3 py-2 text-sm"
                        >
